'''
name:CNN_complicated_cifar10.py
...
def wariable_with_weight_loss(shape,stddev,wl):
...
images_test,labels_test=cifar10_input.distorted_inputs(eval_data=True,data_dir=data_dir,batch_size=batch_size)
